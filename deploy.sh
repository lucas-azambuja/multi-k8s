...
kubectl set image deployments/server-deployment client=lucasazambuja/multi-docker-client:$SHA
kubectl set image deployments/server-deployment worker=lucasazambuja/multi-docker-worker:$SHA